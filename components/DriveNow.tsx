...
const DriveNow = () => {
  ...
  return (
    ...
    <section className='relative w-full py-20 md:py-32 h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10 w-[90%] max-w-7xl mx-auto flex flex-col gap-6 text-center items-center'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-white/80 text-lg md:text-xl max-w-2xl mx-auto'>
            Luxury ownership made accessible with our flexible financing plans
          </p>
        </div>
        ...
        <button className='mt-4 font-bold bg-skyblue hover:bg-white hover:text-black transition-all duration-300 py-4 px-10 rounded-xs text-white'>
